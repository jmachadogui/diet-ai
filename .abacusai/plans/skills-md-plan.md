# Plan: Create `.abacusai/skills.md`

## Goal

Create `.abacusai/skills.md` as a set of **instructive rules** the agent must follow when working on this project. High-level bullet points per skill area.

---

## File to Create

**Path:** `.abacusai/skills.md`
...
- **Telegraf:** all Telegraf-specific code lives only in `packages/messaging/src/adapters/telegram.ts`. Keep bot logic out of `apps/api` service files.
